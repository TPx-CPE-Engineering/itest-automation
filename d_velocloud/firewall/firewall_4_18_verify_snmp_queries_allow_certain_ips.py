...
def are_snmp_settings_set() -> None:
    EDGE.are_snmp_settings_set()


def set_snmp_access_to_allow_ip(ip_allowed: str) -> None:
    EDGE.set_snmp_access_to_allow_ip(ip_allowed=ip_allowed)
